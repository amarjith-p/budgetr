// features/insights/components/insight_account_selection_sheet.dart
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import '../../../core/database/app_database.dart';

class InsightAccountSelectionSheet extends StatelessWidget {
  final List<Account> accounts;
  final String? selectedAccountId;
  final ValueChanged<String?> onSelected;

  const InsightAccountSelectionSheet({
    Key? key,
  ...
  static void show(
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => InsightAccountSelectionSheet(
        accounts: accounts,
  ...
  Widget _buildSheetOption(
    ...
    final isSelected = selectedAccountId == value;
