    ...
    return Scaffold(
      ...
      body: accountsAsync.when(
        ...
        data: (accounts) {
          ...
          final bankAccounts = visibleAccounts.where((a) => a.type != 'Credit Cards').toList();
          ...
          final double crBalance = creditCards.fold(0.0, (sum, acc) => sum + acc.balance);
          ...
          return CustomScrollView(
            ...
            slivers: [
              ...
              if (creditCards.isNotEmpty) ...[
                SliverToBoxAdapter(child: _buildAccountCarousel(context, creditCards)),
              ],

              if (bankAccounts.isEmpty && creditCards.isEmpty && accounts.isNotEmpty)
                 SliverFillRemaining(
                   hasScrollBody: false,
                   child: Center(
