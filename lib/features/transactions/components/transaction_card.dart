...
import '../../../core/utils/location_helper.dart'; // <-- NEW IMPORT
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Could not open Maps. Please ensure a browser or maps app is installed.')),
                              );
                            }
                          }
                        },
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Icon(Icons.open_in_new_rounded, size: 14, color: theme.colorScheme.primary.withOpacity(0.5)),
                            ],
                          ),
                        ),
                      ),
